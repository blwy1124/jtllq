...
async function startElectron(){
  ...
  const args = [ path.join(__dirname, "..", "build", "main", "main.js"), rendererPort, envStr, debugPort ];
...
function copyDylibFiles(){
  fs.cpSync(path.join(__dirname, "../dylib"), path.join(__dirname, "../build/dylib"), { recursive: true });
}
